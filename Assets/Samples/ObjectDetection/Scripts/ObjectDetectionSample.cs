...
using System.Linq;
using NianticSpatial.NSDK.AR.ObjectDetection;
...
public class ObjectDetectionSample : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("Categories to display in the dropdown")]
    ...
    private void OnCategoryNamesAvailable(ARObjectDetectionModelEventArgs args)
    {
    ...
    public void Start()
    {
        ...
        _objectDetectionManager.CategoryNamesAvailable += OnCategoryNamesAvailable;
