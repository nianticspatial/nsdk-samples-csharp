...
public class DepthDisplayDemo : MonoBehaviour
{
    ...
    private void DisplayDepth()
    {
        ...
        // We use NSDK's math library to calculate a display matrix that fits
    ...
    /// <summary>
    /// In this method we show how to display interpolated depth on screen using NSDK Occlusion Extension.
    /// </summary>
    private void DisplayInterpolatedDepth()
    {
        // In this example, we acquire the depth image from NSDK's AR occlusion
